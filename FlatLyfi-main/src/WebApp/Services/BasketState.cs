        ...
        async Task<IReadOnlyCollection<BasketItem>> FetchCoreAsync()
        {
            ...
            foreach (var item in quantities)
            {
                ...
                var orderItem = new BasketItem
                {
                    ...
                    Town = catalogItem.Town,
                    Metro = catalogItem.Metro,
                    TimeToTheMetro = catalogItem.TimeToTheMetro,
                    Address = catalogItem.Address,
                    NumberOfRooms = catalogItem.NumberOfRooms,
                    TotalFloorArea = catalogItem.TotalFloorArea,
                    KitchenArea = catalogItem.KitchenArea,
                    Floor = catalogItem.Floor,
                    LivingArea = catalogItem.LivingArea,
                    Bathroom = catalogItem.Bathroom,
                    Repair = catalogItem.Repair,
                    Furniture = catalogItem.Furniture,
                    Technique = catalogItem.Technique,
                    HouseType = catalogItem.HouseType,
                    InternetAndTV = catalogItem.InternetAndTV,
                    YearBuilt = catalogItem.YearBuilt,
                    FloorsInTheHouse = catalogItem.FloorsInTheHouse,
                    PassengerElevator = catalogItem.PassengerElevator,
                    FreightElevator = catalogItem.FreightElevator,
                    Parking = catalogItem.Parking,
                    Longitude = catalogItem.Longitude,
                    Latitude = catalogItem.Latitude,
                    LinkToProductCard = catalogItem.LinkToProductCard
                };
